...
info: |
  ## Observability in Action Workshop
  Web Summer Camp 2026

  Speakers: Indermohan Singh & Dani Coll, Lead Developer Advocates at Dynatrace
class: text-center
drawings:
  persist: false
...
<p class="text-xl opacity-80 mt-2">A hands-on workshop</p>

<div class="mt-8 opacity-60 text-sm">Web Summer Camp 2026</div>

<div class="mt-10 flex justify-center gap-12">
  <div class="text-center">
    <div class="font-semibold">Indermohan Singh</div>
    <div class="text-sm opacity-60">Lead Developer Advocate · Dynatrace</div>
  </div>
  <div class="text-center">
    <div class="font-semibold">Dani Coll</div>
    <div class="text-sm opacity-60">Lead Developer Advocate · Dynatrace</div>
  </div>
</div>
...
<!--
Welcome everyone to Observability in Action. Introduce yourselves and the event.
-->
...
<div class="grid grid-cols-2 gap-8 mt-6">
  <div v-click class="p-4 rounded-lg border border-primary/20 bg-primary/5">
    <div class="text-lg font-semibold mb-1">01 · Introduction</div>
    <div class="text-sm opacity-70">What is observability and why it matters</div>
  </div>
  <div v-click class="p-4 rounded-lg border border-primary/20 bg-primary/5">
    <div class="text-lg font-semibold mb-1">02 · The Three Pillars</div>
    <div class="text-sm opacity-70">Logs, Metrics, and Traces</div>
  </div>
  <div v-click class="p-4 rounded-lg border border-primary/20 bg-primary/5">
    <div class="text-lg font-semibold mb-1">03 · Hands-on Lab</div>
    <div class="text-sm opacity-70">Instrument a sample application</div>
  </div>
  <div v-click class="p-4 rounded-lg border border-primary/20 bg-primary/5">
    <div class="text-lg font-semibold mb-1">04 · Q&A</div>
    <div class="text-sm opacity-70">Open discussion and wrap-up</div>
  </div>
</div>

<!--
Walk through the agenda. Feel free to adjust timing per section based on audience engagement.
-->
...
<p class="text-xl opacity-70 mt-2">It was great having you at <strong>Web Summer Camp 2026</strong></p>
...
<div class="mt-10">
  <a
    href="#feedback"
    class="px-6 py-3 rounded-lg bg-primary text-white font-semibold text-lg hover:opacity-90 transition-opacity"
  >
    Share Your Feedback
  </a>
</div>

<div class="mt-6 text-sm opacity-50">We read every response — thank you!</div>
